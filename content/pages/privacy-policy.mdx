...
Welcome to **Seedance 2.0** (seedancetwo), an AI video generation platform that converts text or images into cinematic videos with multi-shot storytelling and synchronized audio. At Seedance 2.0, your privacy is of utmost importance to us, and this privacy policy outlines how we collect, use, and protect your personal information when you use our services.

## Information Collection and Use

We collect the following types of data to provide you with a better experience while using Seedance 2.0:
...
2. **Usage Details**
   - **What We Collect**: Information about how you use Seedance 2.0, including your interactions, features accessed, and usage frequency.
   - **Purpose**: To analyze user engagement and improve our services.

3. **Device Information**
   - **What We Collect**: Data regarding the devices you use to access Seedance 2.0, such as device type, operating system, and browser type.
...
6. **Generated Content**
   - **What We Collect**: Text prompts, uploaded images, and generated video content created through the platform.
   - **Purpose**: To provide the AI video generation service and improve output quality.
...
**Website**: [www.seedancetwo.com](https://www.seedancetwo.com)
**Email**: [support@seedancetwo.com](mailto:support@seedancetwo.com)

By using Seedance 2.0, you consent to our privacy policy and agree to its terms. Thank you for trusting us with your information!
