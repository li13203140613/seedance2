      ...
      >
        <div
          className={cn(
            ...
            'text-white',
            'in-data-scrolled:text-foreground in-data-scrolled:border-foreground/5 in-data-scrolled:bg-background/75 in-data-scrolled:border-b in-data-scrolled:backdrop-blur',
