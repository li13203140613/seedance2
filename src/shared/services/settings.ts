...
export async function getSettingGroups() {
  ...
  const settingGroups: SettingGroup[] = [
    ...
    },
    {
      name: 'evolink',
      title: 'EvoLink',
      description: `Custom <a href="https://evolink.ai" class="text-primary" target="_blank">EvoLink</a> settings (Seedance 1.5 Pro)`,
      tab: 'ai',
    },
    {
      name: 'adsense',
...
export async function getSettings() {
  const settings: Setting[] = [
    ...
    },
    {
      ...
      placeholder:
        'Seedance is an AI-powered dance video generation platform.',
      type: 'textarea',
      group: 'appinfo',
      tab: 'general',
    },
  ...
  "premium-yearly": "prod_xxx"
    ...
    },
    {
      ...
      type: 'text',
      placeholder: 'Seedance <no-reply@mail.example.com>',
      group: 'resend',
      tab: 'email',
    },
    {
    ...
    },
    {
      ...
      group: 'evolink',
      tip: 'EvoLink API Key is used to access the Seedance 1.5 Pro video model',
      tab: 'ai',
    },
    {
      ...
      group: 'evolink',
      tab: 'ai',
      tip: 'Use custom storage to save videos generated by EvoLink',
    },
    {
      name: 'adsense_code',
      title: 'Adsense Code',
